function clickSubject(e){
    ...
    if(this.id=="div_env"){
        document.getElementById("div_sub_env_id").style.display = "flex";
    }
    else if(this.id=="div_geo")
    {
        document.getElementById("div_sub_geo_id").style.display = "flex";   
    }
    document.getElementById("div_subjects_id").style.display = "none";
    
}

$(document).ready(function(){
    $(".div_subject").hover(function(){
...
// function init()
// {
//     let elements = document.getElementsByClassName("div_subject");
//     for (let i = 0; i < elements.length; i++) {
//         elements[i].addEventListener("click",  clickSubject);
//         //alert("hello");
//     }
// }
